...
from api.serializers import EnrichmentSerializer, FeedSerializer, IOCSerializer
...
from greedybear.consts import FEEDS_LICENSE, GET, PAYLOAD_REQUEST, SCANNER, GENERAL_HONEYPOTS
...
def feeds(request, feed_type, attack_type, age, format_):
    ...
    serializer = FeedSerializer(iocs, many=True, context={"format_": format_})
    ...
    if format_ == "txt":
        ...
        for ioc in serializer.data:
            text_lines.append(ioc)
        text = "\n".join(text_lines)
        ...
        return JsonResponse({"license": FEEDS_LICENSE, "iocs": serializer.data})
