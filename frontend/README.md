...
- Start GreedyBear containers (see [docs](https://github.com/GreedyBear-Project/GreedyBear/wiki/Installation)). Original dockerized app is accessible on `http://localhost:80`
