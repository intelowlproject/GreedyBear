...
class TestFeatExtraction(CustomTestCase):
    ...
    def test_feature_extraction(self):
        ...
        self.assertEqual(features[0]["attack_count"], 1)
        self.assertEqual(features[0]["last_seen"], today)
        self.assertEqual(features[0]["first_seen"], today)
        ...
        self.assertEqual(features[0]["active_timespan"], 1)
        self.assertEqual(features[0]["active_days_ratio"], 1)
        self.assertEqual(features[0]["login_attempts"], 1)
        self.assertEqual(features[0]["login_attempts_per_day"], 1)
        self.assertEqual(features[0]["interaction_count"], 1)
        self.assertEqual(features[0]["interactions_per_day"], 1)
        self.assertEqual(features[0]["avg_days_between"], 1)
        self.assertEqual(features[0]["std_days_between"], 0)
        self.assertEqual(features[0]["days_since_last_seen"], 0)
        self.assertEqual(features[0]["days_since_first_seen"], 0)
