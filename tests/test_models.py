...
class ModelsTestCase(CustomTestCase):
    def test_ioc_model(self):
        ...
        self.assertTrue(self.ioc.general_honeypot.filter(name__iexact="log4pot").exists())
        self.assertTrue(self.ioc.general_honeypot.filter(name__iexact="cowrie").exists())
